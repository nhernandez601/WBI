[README.md](https://github.com/user-attachments/files/28630552/README.md)
...
The catalog lives in **`data.js`**. It is loaded with your **48-card Lofi Set across 27 series**, each filed under its Bureau **codename**. On the page the cards are **grouped into a section per series** (series A→Z, characters A→Z within each), with a series jump-bar at the top.
...
- **The Lofi Set** — your 48 cards selling Saturday ($5 each, display samples → buy on Whatnot), **grouped by series** (alphabetical). All are 18+ and shown **blurred / "classified" until tapped to declassify**. Tapping a revealed card opens a **large detailed preview** (with a “view full-size image” link).
- **Next Show — Preview** — the **Cyberpunk** and **Vaporwave** lines, advertised as *coming a future show, release date TBD* (not for sale yet).
