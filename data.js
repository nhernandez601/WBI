...
window.WBI_LOFI = [
  ...
  // ---- Drop 2 additions ----
  { id:'lofi-mikasa',   name:'Mikasa',   code:'Steel',     series:'Attack on Titan', frame:'cyber',  price:5, img:'assets/lofi-mikasa.jpg',   pos:'50% 8%', explicit:true,
    blurb:'Case STEEL — dusk-lit suite, striped accents. A cool, composed Lofi case.' },
  { id:'lofi-tamaki-1', name:'Tamaki Kotatsu', code:'Kindle', series:'Fire Force',  frame:'holo',   price:5, img:'assets/lofi-tamaki-1.jpg', pos:'50% 8%', explicit:true,
    blurb:'Case KINDLE — warm ember glow, rose petals. Fire Force, pose I.' },
  { id:'lofi-tamaki-2', name:'Tamaki Kotatsu', code:'Kindle', series:'Fire Force',  frame:'violet', price:5, img:'assets/lofi-tamaki-2.jpg', pos:'50% 8%', explicit:true,
    blurb:'Case KINDLE — neon dusk, rose petals. Fire Force, pose II.' },
  { id:'lofi-shalltear', name:'Shalltear', code:'Marrow',   series:'Overlord',       frame:'cyber',  price:5, img:'assets/lofi-shalltear.jpg', pos:'50% 8%', explicit:true,
    blurb:'Case MARROW — gothic rose suite, lamp glow. Pairs with ECLIPSE (Albedo).' },
  { id:'lofi-sinon',    name:'Sinon',    code:'Meridian',  series:'Sword Art Online', frame:'holo', price:5, img:'assets/lofi-sinon.jpg',   pos:'50% 8%', explicit:true,
    blurb:'Case MERIDIAN — teal lace, soft city bokeh. A crisp Lofi Set case.' },
  { id:'lofi-echidna',  name:'Echidna',  code:'Oracle',    series:'Re:Zero',        frame:'violet', price:5, img:'assets/lofi-echidna.jpg',  pos:'50% 6%', explicit:true,
    blurb:'Case ORACLE — emerald lace, starlit window. A premium Lofi case file.' },
  { id:'lofi-itsuki',   name:'Itsuki',   code:'Quiver',    series:'Quintessential Quintuplets', frame:'cyber', price:5, img:'assets/lofi-itsuki.jpg', pos:'50% 8%', explicit:true,
    blurb:'Case QUIVER — blush-pink wrap, rose petals. Quintuplet sister, filed.' },
  { id:'lofi-miku',     name:'Miku',     code:'Resonance', series:'Quintessential Quintuplets', frame:'holo', price:5, img:'assets/lofi-miku.jpg',   pos:'50% 8%', explicit:true,
    blurb:'Case RESONANCE — sunset skyline, black lace. Quintuplet sister, filed.' },
  { id:'lofi-elizabeth', name:'Elizabeth', code:'Seraph',  series:'Seven Deadly Sins', frame:'violet', price:5, img:'assets/lofi-elizabeth.jpg', pos:'50% 8%', explicit:true,
    blurb:'Case SERAPH — pink frills, city glow. A radiant Lofi Set case.' },
  { id:'lofi-alice',    name:'Alice',    code:'Solus',     series:'Sword Art Online', frame:'holo', price:5, img:'assets/lofi-alice.jpg',   pos:'50% 8%', explicit:true,
    blurb:'Case SOLUS — golden hair, pale lace, night skyline. A premium Lofi case.' },
  { id:'lofi-priscilla', name:'Priscilla', code:'Sovereign', series:'Re:Zero',      frame:'violet', price:5, img:'assets/lofi-priscilla.jpg', pos:'50% 6%', explicit:true,
    blurb:'Case SOVEREIGN — regal red robe, rose petals. A flagship Lofi case.' },
  { id:'lofi-lilia',    name:'Lilia',    code:'Lace',      series:'Mushoku Tensei', frame:'holo',   price:5, img:'assets/lofi-lilia.jpg',    pos:'50% 8%', explicit:true,
    blurb:'Case LACE — soft lamplight, gentle pinks. A delicate Lofi Set case.' },
  { id:'lofi-eris',     name:'Eris',     code:'Tempest',   series:'Mushoku Tensei', frame:'cyber',  price:5, img:'assets/lofi-eris.jpg',     pos:'50% 8%', explicit:true,
    blurb:'Case TEMPEST — fiery red hair, knit wrap, rose petals. A bold Lofi case.' },
];

// ---- PREVIEW (next show — release date TBD): Cyberpunk + Vaporwave ----
window.WBI_CYBER = [
  ...
  { id:'vw-albedo', name:'Albedo', code:'Halo', series:'Overlord · Vaporwave', frame:'holo',
    price:5, img:'assets/card-vw-albedo.jpg', pos:'50% 10%', explicit:true,
    blurb:'Gold holo bomber, neon-rain rooftop. Vaporwave line — coming a future show.' },
  { id:'vw-rem', name:'Rem', code:'Mixtape', series:'Re:Zero · Vaporwave', frame:'violet',
    price:5, img:'assets/card-vw-rem.jpg', pos:'50% 8%', explicit:true,
    blurb:'Pastel “Rem” bomber, heart neon, laser grid. Vaporwave line — future show.' },
  { id:'vw-asuna', name:'Asuna', code:'Sunset', series:'SAO · Vaporwave', frame:'holo',
    price:5, img:'assets/card-vw-asuna.jpg', pos:'50% 8%', explicit:true,
    blurb:'Neon-rain skyline, glossy red trim. Vaporwave line — coming a future show.' },
];
